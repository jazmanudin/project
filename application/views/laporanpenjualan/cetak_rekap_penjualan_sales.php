...
<head>
    <meta charset="utf-8">
    <title>LAPORAN REKAP PENJUALAN SALES</title>
...
<body class="A4" style="width: 70%;">
    <table class="judul">
        <thead>
            <tr>
                <th colspan="9" style="text-align: center;">LAPORAN REKAP PENJUALAN SALES</th>
            </tr>
            <tr>
    ...
    <table class="datatable3">
        <thead>
            <tr>
                <th style="width: 8%;background-color:#0085cd;color:white">ID Sales</th>
                <th style="background-color:#0085cd;color:white">Nama Sales</th>
                <th style="width: 10%;background-color:#0085cd;color:white;text-align:right">Total Bruto</th>
