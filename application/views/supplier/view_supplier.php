                                ...
                                <?php foreach ($data as $d) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-warning btn-sm edit" href="#" data-kode="<?php echo $d->kode_supplier;?>" data-nama="<?php echo $d->nama_supplier;?>" data-ket="<?php echo $d->keterangan;?>"data-alamat="<?php echo $d->alamat;?>" data-nohp="<?php echo $d->no_hp;?>"><i class="mdi mdi-pencil"></i></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
