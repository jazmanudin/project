<div class="row">
    <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="card">
            <div class="card-body">
                <h2 class="header-title" align="center">LAPORAN PEMASUKAN BARANG</h2>
                <form class="form-horizontal" method="post" target="_blank" action="<?php echo base_url(); ?>laporangudang/cetak_pemasukan" autocomplete="off">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <div class="form-group" align="right">
                                ...
                                <button type="export" name="export" id="export" class="btn btn-primary btn-sm mr-2">EXPORT</button>
                            </div>
                        </div>
                    </div>
                </form>
