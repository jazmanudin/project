...
<body class="A4">
    <table class="judul">
        <thead>
            <tr>
                <th colspan="9" style="text-align: center;">LAPORAN PEMASUKAN BARANG</th>
            </tr>
            <tr>
    ...
    <table class="datatable3">
        <thead>
            <tr>
                ...
                <th style="width: 8%;background-color:#0085cd;color:white;text-align:center" rowspan="2">Tanggal Masuk</th>
                <th style="width: 15%;background-color:#0085cd;color:white;text-align:center" rowspan="2">No Pemasukan</th>
                <th style="width: 15%;background-color:#0085cd;color:white;text-align:center" rowspan="2">Jenis Pemasukan</th>
