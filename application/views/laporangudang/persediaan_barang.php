<div class="row">
    <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="card">
            <div class="card-body">
                <h2 class="header-title" align="center">LAPORAN REKAP PERSEDIAAN BARANG</h2>
                <form class="form-horizontal" method="post" target="_blank" action="<?php echo base_url(); ?>laporangudang/cetak_persediaan_barang" autocomplete="off">
                    <div class="row">
