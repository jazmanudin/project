...
?>
    <tr>
        ...
        <td align="center">
            <a class="btn btn-sm btn-danger hapus" href="#" data-kode="<?php echo $d->no_fak_pemb; ?>"><i class="fa fa-trash"></i></a>
            <a class="btn btn-sm btn-warning edit" href="#" data-bayar="<?php echo $d->jumlahbayar; ?>" data-total="<?php echo $subtotal; ?>" data-ket="<?php echo $d->keterangan; ?>" data-jumlah="<?php echo $d->jumlah; ?>" data-kode="<?php echo $d->no_fak_pemb; ?>"><i class="mdi mdi-pencil"></i></a>
        </td>
    </tr>
<?php } ?>
<tr>
...
<script>
    $(document).ready(function() {
        ...
        $('.hapus').click(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url(); ?>pembayaran/hapus_pembayaran_hutang_temp',
                data: {
