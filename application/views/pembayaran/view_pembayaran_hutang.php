<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h2 class="header-title" align="center">DATA PEMBAYARAN HUTANG</h2>
                <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>pembayaran/view_pembayaran_hutang" autocomplete="off">
                    <div class="row">
                ...
                <div class="table-rep-plugin">
                    <a href="<?php echo base_url(); ?>pembayaran/input_bayar_hutang" class="btn btn-primary btn-sm input">Tambah Data</a>
                        ...
                        <table class="table table-striped table-bordered table-hover table-sm">
                            <thead style="background-color: #0085cd;color:white">
                                <tr>
                                    ...
                                    <th style="width: 6%;">Kode Supplier</th>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-danger btn-sm delete" style="color:white;" data-href="<?php echo base_url(); ?>pembayaran/hapus_pembayaran_hutang/<?php echo $d['nobukti']; ?>"><i class="fa fa-trash"></i></a>
                                            <a class="btn btn-warning btn-sm" style="color:white;" href="<?php echo base_url(); ?>pembayaran/edit_pembayaran_hutang/<?php echo $d['nobukti']; ?>"><i class="mdi mdi-pencil"></i></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('.detail').click(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url(); ?>pembayaran/detail_pembayaran_hutang',
                data: {
                    nobukti: nobukti
                },
                cache: false,
