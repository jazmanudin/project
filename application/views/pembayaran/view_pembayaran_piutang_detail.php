...
?>
    <tr>
        ...
        <td align="center">
            <a class="btn btn-sm btn-warning edit" href="#" data-potongan="<?php echo $d->potongan; ?>" data-bayar="<?php echo $d->jumlahbayar; ?>" data-total="<?php echo $subtotal; ?>" data-ket="<?php echo $d->keterangan; ?>" data-jumlah="<?php echo $d->jumlah; ?>" data-kode="<?php echo $d->no_fak_penj; ?>"><i class="mdi mdi-pencil"></i></a>
        </td>
    </tr>
<?php } ?>
<tr>
