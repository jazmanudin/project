<div class="col-lg-12">
    <form autocomplete="off" id="form" class="pelangganForm" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" style="text-align: right;" readonly value="<?php echo number_format($getbayar['total'] - $getbayar['jumlahbayar']); ?>" name="sisabayar" id="sisabayar" class="form-control kosong form-control-sm" placeholder="No Fak Penj" />
        </div>
        <div class="form-group">
