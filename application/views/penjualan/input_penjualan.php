            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-8" style="padding-left:2px;padding-right:0px">
                        <input type="text" class="form-control form-control-sm" readonly id="no_fak_penj" name="no_fak_penj" placeholder="No Faktur">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#kode_pelanggan').change(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url(); ?>penjualan/view_idsales',
                data: {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url(); ?>penjualan/view_namasales',
                data: {
                    kode_pelanggan: kode_pelanggan
                },
                cache: false,
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url(); ?>penjualan/view_jenisharga',
                data: {
                    kode_pelanggan: kode_pelanggan
                },
                cache: false,
