<div class="col-lg-12">
    <form autocomplete="off" id="form" class="pelangganForm" method="POST" enctype="multipart/form-data">
        <div class="form-group">
            ...
            <input type="text" value="<?php echo $getbayar['no_fak_penj']; ?>" name="no_fak_penj" id="no_fak_penj" class="form-control kosong form-control-sm" placeholder="No Fak Penj" />
        </div>
        <div class="form-group">
        ...
        <div class="form-group mb-0">
            <a class="btn btn-primary btn-sm btn-block inputpiutang" href="#">Simpan</a>
        </div>
...
<script>
    $(document).ready(function() {
        ...
        $('.inputpiutang').click(function(e) {
            e.preventDefault();
            var no_fak_penj = $('#no_fak_penj').val();
            var jmlbayar = $('#jmlbayar').val();
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url(); ?>penjualan/insert_piutang',
                data: {
