                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-8" style="padding-left:7px;padding-right:0px">
                            <input class="form-control form-control-sm" readonly value="<?php echo $getdata['kode_saldoawal']; ?>" id="kode_saldoawal" name="kode_saldoawal" placeholder="Kode Saldo Awal">
                        ...
                        <div class="col-md-12" style="padding-left:7px;padding-right:0px">
                            <div class="table-responsive mb-0">
                                <table id="tech-companies-1" class="table table-striped table-bordered table-hover table-sm">
                                    ...
                                    <tbody id="loaddetailsaldoawal" style="font-size: 13px;">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function view_detailsaldoawal() {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url(); ?>saldoawal/view_saldoawal_detail',
                data: {
        ...
        $('#simpanbarang').click(function(e) {
            ...
            if (kode_barang == "") {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo base_url(); ?>saldoawal/insert_saldoawal_detail',
                    data: {
                        kode_saldoawal: kode_saldoawal,
